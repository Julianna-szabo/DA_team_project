...
```
In order to avoid confusion on the analysis between On-site and Delivery, we took out the beverage and just analyse the margharita price. (Due to the beverages not being uniform)
